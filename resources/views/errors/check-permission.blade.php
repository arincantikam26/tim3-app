...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <p class="mb-4 mx-2">Oops! You don't have permission for access this page <br /> Please contact you
                Superadmin!</h1>
            </p>

            <div class="mt-3">
                <img src="/assets/image/page-misc-error-light.png" alt="page-misc-error-light" width="500"
                    class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png"
                    data-app-light-img="image/page-misc-error-light.png" />
            </div>
        </div>
    </div>
