...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="table-responsive text-nowrap">
            <div class="row">
                <form class="needs-validation forms-sample" method="POST" action="{{ route('admin-user.store') }}" novalidate>
                    @csrf
                    <div class="col-lg-6 offset-2 col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder=" "
                                aria-describedby="helpId" required="required" value="{{ old('name') }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" class="form-control" placeholder=" "
                                aria-describedby="helpId" required="required" value="{{ old('username') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" placeholder=" "
                                aria-describedby="helpId" required="required" value="{{ old('email') }}">
                            @if ($errors->has('email'))
