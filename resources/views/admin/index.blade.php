        ...
        <div class="row">
            <div class="col-md">
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img class="card-img card-img-left" src="{{ asset('assets/image/admin_hero.jpg') }}"
                                alt="Card image" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-lg-3 col-md-3 order-0 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <small class="text-success fw-semibold"><a href="/admin/jurusan"> Details <i
            ...
            <div class="col-lg-3 col-md-3 order-0 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <small class="text-success fw-semibold"><a href="/admin/prodi"> Details <i
                                    class="fa-solid fa-angles-right"></i></a></small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 order-0 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <small class="text-success fw-semibold"><a href="{{ route('admin-user.index') }}"> Details <i
                                    class="fa-solid fa-angles-right"></i></a></small>
                    </div>
                </div>
            </div>
