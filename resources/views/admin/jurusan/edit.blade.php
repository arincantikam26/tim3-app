...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="table-responsive text-nowrap">
            <div class="row">
                <form class="needs-validation forms-sample" method="POST" action="{{ route('jurusan.update', $jurusan->id) }}"
                    novalidate>
                    @csrf
                    @method('PUT')
                    <div class="col-lg-6 offset-2 col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nama_jurusan" name="nama_jurusan" class="form-control"
                                placeholder="Nama Jurusan" aria-describedby="helpId" required="required"
