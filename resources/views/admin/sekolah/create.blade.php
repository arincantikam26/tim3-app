...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="table-responsive text-nowrap">
            <div class="row">
                <form class="needs-validation forms-sample" method="POST" action="{{ route('admin-sekolah.store') }}" novalidate>
                    @csrf
                    <div class="col-lg-6 offset-2 col-md-4">
                        ...
                        <div class="mb-5">
                            ...
                            <a href="{{ route('admin-sekolah.index') }}" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
